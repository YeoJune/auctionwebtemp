...
class MyPageManager {
  ...
  renderBidResultsSection() {
    ...
    this.bidResultsCore.updatePagination((page) =>
      this.handleBidResultsPageChange(page)
    );
  ...
  updateBidResultsUI() {
    ...
    // 정렬 버튼 업데이트
    this.bidResultsCore.updateSortButtonsUI();
  }
  ...
  setupBidResultsEvents() {
    // 기간 드롭다운
    document
      .getElementById("dateRangeResults")
    ...
    // 필터 적용 버튼
    document
      .getElementById("applyResultsFilters")
    ...
    // 필터 초기화 버튼
    document
      .getElementById("resetResultsFilters")
      ?.addEventListener("click", () => {
